...
class SidebarMenuResource extends TreeResource
{
    public static string $model = Menu::class;

    public static string $title = 'Боковое';
    ...
    {
        return parent::query()->where('type', 4);
    }
    ...
    public function fields(): array
    {
        return [
            ...
            Block::make('', [
                ...
                Number::make('Type', 'type')->default(4)->hidden()
            ]),
        ];
    }
